...
parser.add_argument('-m', '--model', choices=['molmo', 'molmo-72b', 'qwen-vl', 'clip', 'qwen-vl-72b'])
# parser.add_argument('-pt', '--prompt_type', choices=['reg', 'nlg']) # reg for regular, nlg for analogy 
...
if args.model == 'qwen-vl' or args.model == 'qwen-vl-72b':
    ...
    for action_word in action_words:
        ...
        for label_permutation in label_permutations:
            ...
            label_1, label_2, label_3, label_4 = label_permutation
            prompt = f"Example task: Consider the event 'threw' and the four images below (SHTL, XHWK, AKRC, ZHRN). Think of an analogy to help you answer the following question: Which of the images best represents the event? Explain the analogy, then provide your image choice.\nAnalogy: 'throwing' often involves launching an object in a horizontal direction. The trajectory followed by the object could be represented as a rightward-pointing arrow.\nImage: XHWK\n\nTask: Consider the event '{action_word}' and the four images below (SHTL, XHWK, AKRC, ZHRN). Think of an analogy to help you answer the following question: Which of the images best represents the event? Explain the analogy, then provide your image choice.\nAnalogy: "
...
dict_to_json(out_dict, ROOT / f'src/fullpaper/results/vlms/{args.model}_human_oneshot_analogy.json')
